...
class SimSnapshot(_message.Message):
    __slots__ = ("created_at", "ant_ids", "ants", "crumbs")
    ...
    def __init__(self, created_at: _Optional[int] = ..., ant_ids: _Optional[_Iterable[bytes]] = ..., ants: _Optional[_Iterable[_Union[AntState, _Mapping]]] = ..., crumbs: _Optional[_Iterable[_Union[CrumbState, _Mapping]]] = ...) -> None: ...
